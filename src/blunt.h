...
// binop1:  +  -  *  /
static t_float fn_plus(t_float f1, t_float f2) {
	return (f1 + f2);
}
static t_float fn_minus(t_float f1, t_float f2) {
	return (f1 - f2);
}
static t_float fn_times(t_float f1, t_float f2) {
	return (f1 * f2);
}
static t_float fn_div(t_float f1, t_float f2) {
	return (f2 != 0 ? f1 / f2 : 0);
}
...
static t_float fn_max(t_float f1, t_float f2) {
	return (f1 > f2 ? f1 : f2);
}
static t_float fn_min(t_float f1, t_float f2) {
	return (f1 < f2 ? f1 : f2);
}

// binop2:  ==  !=  >  <  >=  <=
static t_float fn_ee(t_float f1, t_float f2) {
	return (f1 == f2);
}
static t_float fn_ne(t_float f1, t_float f2) {
	return (f1 != f2);
}
static t_float fn_gt(t_float f1, t_float f2) {
	return (f1 > f2);
}
static t_float fn_lt(t_float f1, t_float f2) {
	return (f1 < f2);
}
static t_float fn_ge(t_float f1, t_float f2) {
	return (f1 >= f2);
}
static t_float fn_le(t_float f1, t_float f2) {
	return (f1 <= f2);
}

// binop3:  &  |  &&  ||  <<  >>  ^  %  mod  div
static t_float fn_ba(t_float f1, t_float f2) {
	return ((int)f1 & (int)f2);
}
static t_float fn_la(t_float f1, t_float f2) {
	return ((int)f1 && (int)f2);
}
static t_float fn_bo(t_float f1, t_float f2) {
	return ((int)f1 | (int)f2);
}
static t_float fn_lo(t_float f1, t_float f2) {
	return ((int)f1 || (int)f2);
}
static t_float fn_ls(t_float f1, t_float f2) {
	return ((int)f1 << (int)f2);
}
static t_float fn_rs(t_float f1, t_float f2) {
	return ((int)f1 >> (int)f2);
}
static t_float fn_xor(t_float f1, t_float f2) {
	return ((int)f1 ^ (int)f2);
}
static t_float fn_fpc(t_float f1, t_float f2) {
	return FMOD(f1, f2);
}
...
static t_float fn_divm(t_float f1, t_float f2) {
	...
	return (t_float)(n1 / n2);
}

// unop:  int  float  !  ~  factorial
static t_float fn_float(t_float f) {
	return f;
}
static t_float fn_int(t_float f) {
	return  (int64_t)f;
}
static t_float fn_lnot(t_float f) {
	return !(int64_t)f;
}
static t_float fn_bnot(t_float f) {
	return ~(int64_t)f;
}
...
static inline void bop_set(t_bop *x, t_symbol *s, int ac, t_atom *av) {
	...
	if (ac > 1 && av[1].a_type == A_FLOAT) {
		x->f2 = av[1].a_w.w_float;
	}
	if (ac && av[0].a_type == A_FLOAT) {
		x->f1 = av[0].a_w.w_float;
	}
}
